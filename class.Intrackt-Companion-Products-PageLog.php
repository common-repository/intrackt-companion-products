...
/*
 * The PageLog class will display any log messages generated by the CompanionProducts plugin
 */
class PageLog {
    ...
    public static function displayPage() {
        ...
        $mostRecent=$wpdb->get_var("
            ...
            FROM {$tname}
            WHERE inlog_plugin = '".INTRACKT_PLUGIN_NAME_COMPANIONPRODUCTS."'
        ...
        <h2>CompanionProducts Plugin Status</h2>
        ...
        */
        ...
        <h2>CompanionProducts Process Log</h2>
    ...
    public static function updateLog($message) {
        ...
        $result=$wpdb->query($wpdb->prepare(
            ...
            ,INTRACKT_PLUGIN_NAME_COMPANIONPRODUCTS,$message));
    }    
    ...
    public static function updateTestLog($message) {
         ...
         */
        if (INTRACKT_COMPANIONPRODUCTS_TESTMODE) {
